				...
				<div class="inform right">
					...
					<div class="item-desc">
						...
						<div class="item-links">
							<p class="desc">Lightpack requires a connection to computer or Android device with Prismatik software installed. Prismatik can be obtained at <a href="#">http://lightpack.tv/downloads</a></p>
							<p class="desc">Prismatik is compatible with Windows, Mac OS X, Linux, Android, and works with many Android-based media centers. See <a href="#">FAQ</a> for details and software limitations.</p>
						</div>
					</div>
				</div>
			</div>
